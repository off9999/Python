...
while True:
    choice = int(input("Виберіть опцію (1 - обчислити z, 2 - знайти середнє арифметичне парних чисел): "))
    if choice == 1:
        result = calculate_z()
        ...
        print("Середнє арифметичне парних чисел від", x, "до", y, "дорівнює", average)
        break
    else:
